...
#include <string.h>
#include <math.h>
/* This function is a C implementation by Guillaume Alain and Gavin Ha
...
void preparePositionSpecificMatrix(double * transSlice, double * C, unsigned int, double * ZS, double, unsigned int);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    int K, T, tmp, tmp1, transitionMatrixStrides, cnStates;
    ...
    copyNumber=mxGetPr(prhs[3]);/* copy number vector, 6xN */
    ...
    for(t=1;t<T;++t) { /* position */
        ...
        preparePositionSpecificMatrix(transSlice, C, K, ZS, rho, 0); 
...
void preparePositionSpecificMatrix(double * transSlice, double * C, unsigned int K, double * ZS, double rho, unsigned int boolTest) {
    unsigned int i, j;
    double sum;
